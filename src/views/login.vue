       ...
       <div class="card  w-full sm:w-4/5 bg-white rounded shadow-xl mx-auto mb-5 p-4">
            ...
            <form>
                <div class="mb-4">
                    ...
                    <input type="text" name="username" class="rounded shadow-md w-full py-2 px-3 border border-indigo-800 text-gray-700 leading-tight   focus:boder-none" placeholder="john@amith.com">
                </div>
                <div class="mb-6">
